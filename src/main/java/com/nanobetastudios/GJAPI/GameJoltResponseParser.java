...
/**
 * Abstract parser for GameJolt responses
 * @author Alastor
 * @since 1.0.0
 * @version 1.0.0
 */
public abstract class GameJoltResponseParser {
    private final String[] userProperties = {"id", "username", "avatar_url", "signed_up", "last_logged_in"};
    private final String[] highscoreProperties = {"score", "extra_data", "user", "user_id", "guest", "stored"};
    private final String[] highscoreTableProperties = {"id",  "name", "description", "primary"};
    private final String[] trophyProperties = {"id", "title", "description", "difficulty", "image_url", "achieved"};
    private final String[] serverTimeProperties = {"year", "month", "day", "hour", "minute", "seconds"};
